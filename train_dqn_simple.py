    ...
    def train(self, num_episodes: int, save_freq: int = 100):
        ...
        for episode in range(num_episodes):
            ...
            if episode % save_freq == 0 and episode > 0:
                self.save_model(f"simple_dqn_spider_{episode}.pt")
...
def main():
    ...
    # Save final model
    agent.save_model("simple_dqn_spider_final.pt")
    
    # Plot results
    plot_training_results(rewards, lengths, "simple_dqn_training_results.png")
